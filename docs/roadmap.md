...
### R11 — Initiative tracker (DM combat tool) — promoted from Future/Stretch (2026-07-17)
...
- [ ] Custom profile avatars (upload + serving, or interim: render existing Discord `avatarUrl`) — *deferred to Future/Stretch from R11 on 2026-07-17*

...
- [ ] **R9.4 — Item Detail (Two-column).** Separate `/item/:id` page. Description/charges (Use/Recharge)/notes left; state toggles + edit + per-item history right. Identify invariant + hint editor.

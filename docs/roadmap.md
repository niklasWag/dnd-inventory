...
- [ ] **R9.11 — Hub + Settings.** Hub Hero (no-gear-pip medallion) as default + List+Detail as the user-selectable alternative; Settings with the **Appearance cluster** (theme / accent / follow-class / Hub-layout).

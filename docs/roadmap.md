...
- [ ] **R9.6 — Catalog + Custom Item + shared ItemPicker.** Catalog Table; Custom Item Editor (single-column, magic-only reveal) as the sole homebrew entry; the shared `ItemPicker` (`layout="list"` default + `layout="rail"` for DM).
